...
<link rel ="stylesheet" href = "Hd1_style1.css" type = "text/css" />
<script type = "text/javascript" src = "Hd1_java.js"></script>
...
<form>
        ...
        <input type = "text" id = "nav4" value="<?php echo $nav4T ?>" size = "20"/>&nbsp&nbsp
        <label id = "nav5" ><a href = "Hd2.php" style="color:#163576;"><?php echo $nav5T ?></a></label>&nbsp&nbsp
		...
		while(($file=readdir($opendir))!== FALSE)
			{
				...
				if ($file!="."&&$file!="..")
				{
					...
					</div>"."<a style='color:#163576;'href='Hd1Photo.php'>Change Profile Photo</a>
...
<div><img id="uploadimage"  src="setHd1Photo/image.jpg"  alt="uploadImage"></div>
<a href="Hd1Photo.php" style="color:#163576;">Change profile photo</a><br>
...
<button><a href = "Hd1Update.php">Publish the website</a></button><br><br>
