<?php
    ...
    //get the header font
    $sql = "SELECT font FROM Text where name = 'header'";
    ...
    //get the header size
    $sql = "SELECT size FROM Text where name = 'header'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT color FROM Text where name = 'header'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT position FROM Text where name = 'header'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT font FROM Text where name = 'subheader'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT size FROM Text where name = 'subheader'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT color FROM Text where name = 'subheader'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT back_color FROM Text where name = 'nav'";
    $result = mysqli_query($conn, $sql);
