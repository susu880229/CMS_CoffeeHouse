...
<body onload="readTextFile();alertBox()">
		...
		<div><img id="uploadimage"  src="setSalesPhoto/image.jpg"  alt="uploadImage" width='300px' height='300px'></div>
...
<div id="content" ></div>
<button><a href = "Sales.php">Edit Page</a></button><br><br>
