...
<link rel ="stylesheet" href = "Sales_style1.css" type = "text/css" />
<script type = "text/javascript" src = "Sales_java.js"></script>
...
function readTextFile(){
    ...
    tinyMCE.get('display').setContent(xhttp.responseText);
  	...
  	xhttp.open("GET", "tinyMCE_Data/Sales.html", true);
  	xhttp.send();
...
<?php
    ...
    //get the header text
    $sql = "SELECT text FROM sales where name = 'header'";
    ...
    $sql = "SELECT text FROM sales where name = 'subheader'";
    $result = mysqli_query($conn, $sql);
...
<form>
        ...
        <input type = "text" id = "nav3" value="<?php echo $nav3T ?>" size = "20"/>&nbsp&nbsp
...
if(isset($_POST['SetImage']))
	{
		...
		$newfile = 'setSalesPhoto/image.jpg';
		...
		while(($file=readdir($opendir))!== FALSE)
			{
				...
				if ($file!="."&&$file!="..")
				{
					...
					</div>"."<a style='color:#163576;'href='SalesPhoto.php'>Change Profile Photo</a>
...
<div><img id="uploadimage"  src="setSalesPhoto/image.jpg"  alt="uploadImage"></div>
<a href="SalesPhoto.php" style="color:#163576;">Change profile photo</a><br>
...
<button><a href = "SalesUpdate.php">Publish the website</a></button><br><br>
