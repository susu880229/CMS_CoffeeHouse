...
<body onload="readTextFile();alertBox()">
		...
		<div><img id="uploadimage"  src="setHd2Photo/image.jpg"  alt="uploadImage" width='300px' height='300px'></div>
...
<div id="content" ></div>
<button><a href = "Hd2.php">Edit Page</a></button><br><br>
