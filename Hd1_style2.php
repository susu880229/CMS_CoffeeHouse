<?php
    ...
    //get the header font
    $sql = "SELECT font FROM hd1 where name = 'header'";
    ...
    //get the header size
    $sql = "SELECT size FROM hd1 where name = 'header'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT color FROM hd1 where name = 'header'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT position FROM hd1 where name = 'header'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT font FROM hd1 where name = 'subheader'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT size FROM hd1 where name = 'subheader'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT color FROM hd1 where name = 'subheader'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT back_color FROM hd1 where name = 'nav'";
    $result = mysqli_query($conn, $sql);
