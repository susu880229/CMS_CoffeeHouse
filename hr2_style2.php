<?php
    ...
    //get the header font
    $sql = "SELECT font FROM HR2 where name = 'header'";
    ...
    //get the header size
    $sql = "SELECT size FROM HR2 where name = 'header'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT color FROM HR2 where name = 'header'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT position FROM HR2 where name = 'header'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT font FROM HR2 where name = 'subheader'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT size FROM HR2 where name = 'subheader'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT color FROM HR2 where name = 'subheader'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT back_color FROM HR2 where name = 'nav'";
    $result = mysqli_query($conn, $sql);
