...
<meta name="" content="">
<style>
	<?php include 'hr1_style2.php';?>
</style>
<script src="httpsf://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js"></script>
<script>
...
<body onload="readTextFile();alertBox()">
		...
		<div><img id="uploadimage"  src="setHr1Photo/image.jpg"  alt="uploadImage" width='300px' height='300px'></div>
...
<div id="content" ></div>
<button><a href = "Hr1.php">Edit Page</a></button><br><br>
