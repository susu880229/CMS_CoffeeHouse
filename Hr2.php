...
<link rel ="stylesheet" href = "hr2_style1.css" type = "text/css" />
<script type = "text/javascript" src = "hr2_java.js"></script>
...
<form>
        ...
        <br>
         <textarea name = "header" id = "header" rows="1" cols = "80"><?php echo $header ?></textarea></textarea><br><br>
        <br><br>
        
        <!-- navigation edit part -->
        <div id = "navi">
        
        <label id = "nav1" ><a href = "Hr1.php" style="color:#163576;"><?php echo $nav1T ?></a></label>&nbsp&nbsp
        <input type = "text" id = "nav2" value="<?php echo $nav2T ?>" size = "20"/>&nbsp&nbsp
		...
		while(($file=readdir($opendir))!== FALSE)
			{
				...
				if ($file!="."&&$file!="..")
				{
					...
					</div>"."<a style='color:#163576;'href='Hr2Photo.php'>Change Profile Photo</a>
...
<div><img id="uploadimage"  src="setHr2Photo/image.jpg"  alt="uploadImage"></div>
<a href="Hr2Photo.php" style="color:#163576;">Change profile photo</a><br>
...
<button><a href = "hr2Update.php">Publish the website</a></button><br><br>
