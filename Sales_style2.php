<?php
    ...
    //get the header font
    $sql = "SELECT font FROM sales where name = 'header'";
    ...
    //get the header size
    $sql = "SELECT size FROM sales where name = 'header'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT color FROM sales where name = 'header'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT position FROM sales where name = 'header'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT font FROM sales where name = 'subheader'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT size FROM sales where name = 'subheader'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT color FROM sales where name = 'subheader'";
    $result = mysqli_query($conn, $sql);
    ...
    $sql = "SELECT back_color FROM sales where name = 'nav'";
    $result = mysqli_query($conn, $sql);
